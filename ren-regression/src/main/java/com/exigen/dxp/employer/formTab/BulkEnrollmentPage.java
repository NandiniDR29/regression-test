...
public class BulkEnrollmentPage {
    ...
    public BulkEnrollmentPage(WebDriver driver, WebDriverWait wait, Robot robot, Actions builder,
                              Properties prop) {
...
//        driver.manage().timeouts().implicitlyWait(2, TimeUnit.MINUTES);
        ...
        uploadFile.click();
        File file = new File(PropertyProvider.getProperty(TestProperties.UPLOAD_FILES_LOCATION), "Enrollment5.pdf");
