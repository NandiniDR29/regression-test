...
import com.exigen.modules.caseprofile.metadata.QuotesSelectionActionTabMetaData;
...
public class QuotesSelectionActionTab extends ActionTab {
    ...
    public Tab fillTab(TestData td) {
        if (td.containsKey(assetList.getName())) {
                selectQuoteByNumber(CommonBaseTest.prop.getProperty("MPNumber"));
        }
        assetList.fill(td);
        return this;
    }
    ...
    public static void selectQuoteByNumber(String policyNumber) {
            new CheckBox(By.xpath("//span[contains(text(),'"+policyNumber+"')]/../../../../../preceding-sibling::td[1]//input")).setValue(true);
    }
}
