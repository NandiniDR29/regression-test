...
public class BenefitSTDInjuryPartyInformationTabMetaData extends MetaData {
    public static final AssetDescriptor<Link> ADD_NEW_BENEFIT_STD = declare("Add Benefit: Short Term Disability", Link.class, By.id("productConsolidatedViewForm:addDamageShortTermDisability"));
    ...
    public static final AssetDescriptor<BenefitSTDInjuryPartyInformationTab.YTDTaxableWageMultiAssetList> YTD_TAXABLE_WAGE =
            declare("YTD Taxable Wage", BenefitSTDInjuryPartyInformationTab.YTDTaxableWageMultiAssetList.class, BenefitLTDInjuryPartyInformationTabMetaData.YTDTaxableWageMetaData.class, By.id("policyDataGatherForm:formGrid_STDPartyYTDTaxableWage"));
