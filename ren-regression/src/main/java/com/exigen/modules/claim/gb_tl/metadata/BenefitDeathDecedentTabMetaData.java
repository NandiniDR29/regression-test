...
public class BenefitDeathDecedentTabMetaData extends MetaData {
    public static final AssetDescriptor<Link> ADD_NEW_BENEFIT_DEATH = declare("Add Benefit: Death", Link.class, By.id("productConsolidatedViewForm:addDamageDeath"));
    public static final AssetDescriptor<Link> ADD_NEW_BENEFIT_ACCIDENTAL_DEATH = declare("Add Benefit: Accidental Death", Link.class, By.id("productConsolidatedViewForm:addDamageAccidentalDeath"));
