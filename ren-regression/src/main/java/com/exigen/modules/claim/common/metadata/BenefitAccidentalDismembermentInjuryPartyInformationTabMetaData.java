...
public class BenefitAccidentalDismembermentInjuryPartyInformationTabMetaData extends MetaData {
    public static final AssetDescriptor<Link> ADD_BENEFIT_ACCIDENTAL_DISMEMBERMENT = declare("Add Benefit: Accidental Dismemberment", Link.class, By.id("productConsolidatedViewForm:addDamageAccidentalDismemberment"));
