...
public class BenefitsStatutorySTDInjuryPartyInformationTab extends DefaultTab {
    public static final Button addYTDTaxableWage = new Button(By.id("policyDataGatherForm:addStatPartyYTDTaxableWage"));

    public BenefitsStatutorySTDInjuryPartyInformationTab() {
        super(BenefitsStatutorySTDInjuryPartyInformationTabMetaData.class);
    }
