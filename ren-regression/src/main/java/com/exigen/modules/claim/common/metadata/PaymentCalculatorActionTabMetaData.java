...
public class PaymentCalculatorActionTabMetaData extends MetaData {
    ...
    public static final AssetDescriptor<PaymentCalculatorTab.PaymentTaxMultiAssetList> PAYMENT_TAX = declare("Payment Tax", PaymentCalculatorTab.PaymentTaxMultiAssetList.class, PaymentTaxMetaData.class, By.xpath("//span[@id='policyDataGatherForm:componentRegion_ClaimsPaymentTaxCalculator']/div"));
