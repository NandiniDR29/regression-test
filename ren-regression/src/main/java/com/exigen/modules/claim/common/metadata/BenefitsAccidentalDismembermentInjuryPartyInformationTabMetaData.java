...
import static com.exigen.ren.main.modules.claim.common.tabs.BenefitsAccidentalDismembermentInjuryPartyInformationTab.ItemizedInjuryIllnessAssetList;

public class BenefitsAccidentalDismembermentInjuryPartyInformationTabMetaData extends MetaData {
    ...
    public static final AssetDescriptor<ItemizedInjuryIllnessAssetList> ITEMIZED_INJURY_ILLNESS = declare("Itemized Injury/Illness",
            ItemizedInjuryIllnessAssetList.class, ItemizedInjuryIllnessMetaData.class, By.xpath("//div[@id='policyDataGatherForm:componentView_PrecClaimsADLossItems']"));

    public static final class ItemizedInjuryIllnessMetaData extends MetaData {
