...
public class ClaimReopenActionTabMetaData extends MetaData {
    ...
    public static final AssetDescriptor<ComboBox> REOPEN_TO_STATUS = declare("Reopen to (Status):", ComboBox.class);
