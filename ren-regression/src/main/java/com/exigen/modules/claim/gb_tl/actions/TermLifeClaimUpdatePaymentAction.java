...
import com.exigen.ren.main.modules.claim.gb_tl.actions.TermLifeClaimAddPaymentAction;
import org.openqa.selenium.By;

public class TermLifeClaimUpdatePaymentAction extends UpdatePaymentAction {

    @Override
    public Workspace getWorkspace() {
        return AutomationContext.getAction(TermLifeClaimAddPaymentAction.class).getWorkspace();
    }
