...
public class BenefitsPFLQualifyingEventTabMetaData extends MetaData {
    ...
    public static final AssetDescriptor<RadioGroup> FORM_SUBMITTED_IN_ADVANCE = declare("Form submitted in Advance", RadioGroup.class);
    public static final AssetDescriptor<TextBox> DATE_OF_HIRE = declare("Date of hire", TextBox.class);
    public static final AssetDescriptor<TextBox> OCCUPATION_CODE = declare("Occupation Code", TextBox.class);
