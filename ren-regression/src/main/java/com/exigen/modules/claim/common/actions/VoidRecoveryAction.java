...
public class VoidRecoveryAction implements Action {
    ...
    public Action submit() {
        new Button(By.id("policyDataGatherForm:ok_ClaimsDeclineRecoveryAction_footer")).click();
        return this;
    }
}
