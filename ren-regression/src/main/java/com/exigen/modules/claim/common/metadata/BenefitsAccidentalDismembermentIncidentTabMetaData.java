...
public class BenefitsAccidentalDismembermentIncidentTabMetaData extends MetaData {
    ...
    public static final AssetDescriptor<TextBox> REPORTED_LOCATION_OF_ACCIDENT = declare("Reported Location of pName", TextBox.class);
