...
public class ClaimCoordinationRelatedClaimsActionTabMetaData extends MetaData {
    public static final AssetDescriptor<TextBox> CLAIM = declare("Claim #", TextBox.class);
    public static final AssetDescriptor<ComboBox> TYPE_OF_RELATED_CLAIM = declare("Type of Related Claim", ComboBox.class);
    public static final AssetDescriptor<ComboBox> STATUS = declare("Status", ComboBox.class);
    public static final AssetDescriptor<TextBox> INSURER = declare("Insurer", TextBox.class);
    ...
    public static final AssetDescriptor<TextBox> RELATED_CLAIM_COMMENTS = declare("Related Claim Comments", TextBox.class);
}
