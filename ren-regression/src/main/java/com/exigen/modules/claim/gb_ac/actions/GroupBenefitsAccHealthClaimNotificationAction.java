...
import com.exigen.ren.main.modules.claim.gb_ac.actions.GroupBenefitsAccHealthCreateAction;

public class GroupBenefitsAccHealthClaimNotificationAction extends ClaimNotificationAction {
    @Override
