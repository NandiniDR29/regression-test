...
public class ClaimHandlingClaimFileOwnerTabMetaData extends MetaData {
    public static final AssetDescriptor<DialogSingleSelector> CLAIM_FILE_OWNER = declare("Claim File Owner", DialogSingleSelector.class,
            com.exigen.ren.main.modules.claim.common.metadata.ClaimHandlingClaimFileOwnerTabMetaData.ClaimFileOwnerMetaData.class, By.id("fileOwnerSearchPopup_Claims_container"));
