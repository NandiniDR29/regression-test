...
public class BenefitActionTabMetaData extends MetaData {
    public static final AssetDescriptor<TextBox> BENEFIT_TYPE = declare("Benefit Type", TextBox.class);
    public static final AssetDescriptor<TextBox> ASSOCIATED_PARTY = declare("Associated Party", TextBox.class);
    public static final AssetDescriptor<TextBox> TOTAL_BENEFIT_AMOUNT = declare("Total Benefit Amount", TextBox.class);
    public static final AssetDescriptor<TextBox> TOTAL_BENEFIT_AMOUNT_PAID = declare("Total Benefit Amount Paid", TextBox.class);
    public static final AssetDescriptor<TextBox> TOTAL_BENEFIT_AMOUNT_REMAINING = declare("Total Benefit Amount Remaining", TextBox.class);
    ...
    public static final AssetDescriptor<TextBox> BENEFIT_AMOUNT_PAID = declare("Benefit Amount Paid", TextBox.class);
    public static final AssetDescriptor<TextBox> BENEFIT_AMOUNT_REMAINING = declare("Benefit Amount Remaining", TextBox.class);
