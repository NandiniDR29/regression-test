...
public class ClaimCoordinationAdditionalInsuranceActionTabMetaData extends MetaData {
    public static final AssetDescriptor<TextBox> ADVERSE_CARRIER = declare("Adverse Carrier", TextBox.class);
    public static final AssetDescriptor<TextBox> POLICY_WITH_ADVERSE_CARRIER = declare("Policy # with Adverse Carrier", TextBox.class);
    public static final AssetDescriptor<TextBox> RELATED_CLAIM_WITH_ADVERSE_CARRIER = declare("Related Claim # with Adverse Carrier", TextBox.class);
    public static final AssetDescriptor<RadioGroup> MEDICARE_SCREEN_COMPLETED = declare("Medicare Screen Completed", RadioGroup.class);
    public static final AssetDescriptor<ComboBox> PARTY_NAME = declare("Party Name", ComboBox.class);
    public static final AssetDescriptor<TextBox> ADJUSTER_WITH_ADVERSE_CARRIER_FIRST_NAME = declare("Adjuster with Adverse Carrier-First Name", TextBox.class);
    public static final AssetDescriptor<TextBox> ADJUSTER_WITH_ADVERSE_CARRIER_LAST_NAME = declare("Adjuster with Adverse Carrier-Last Name", TextBox.class);
