...
public class PolicyInformationPartiesInsuranceAgentActionTabMetaData extends MetaData {
    ...
    public static final AssetDescriptor<TextBox> AGENT_ID = declare("Agent ID", TextBox.class);
