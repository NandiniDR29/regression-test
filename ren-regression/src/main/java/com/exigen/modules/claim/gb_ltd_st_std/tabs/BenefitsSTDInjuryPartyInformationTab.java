...
public class BenefitsSTDInjuryPartyInformationTab extends DefaultTab {
    public static final Button addYTDTaxableWage = new Button(By.id("policyDataGatherForm:addSTDPartyYTDTaxableWage"));

    public BenefitsSTDInjuryPartyInformationTab() {
        super(BenefitsSTDInjuryPartyInformationTabMetaData.class);
    }
