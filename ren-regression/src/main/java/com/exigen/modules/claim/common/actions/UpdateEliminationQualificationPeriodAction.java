...
import com.exigen.ren.main.modules.claim.common.tabs.EliminationQualificationPeriodActionTab;
import com.exigen.ren.main.pages.summary.claim.ClaimAdjudicationBenefitPage;
import org.openqa.selenium.By;

public class UpdateEliminationQualificationPeriodAction implements Action {

    private Workspace workspace = new Workspace.Builder()
            .registerTab(EliminationQualificationPeriodActionTab.class)
            .build();

    @Override
    public String getName() {
        return "Update Elimination/Qualification Period";
    }
