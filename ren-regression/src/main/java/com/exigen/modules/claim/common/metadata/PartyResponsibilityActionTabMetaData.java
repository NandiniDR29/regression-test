...
public class PartyResponsibilityActionTabMetaData extends MetaData {
    public static final AssetDescriptor<TextBox> LIABILITY = declare("Liability %", TextBox.class);
    public static final AssetDescriptor<ComboBox> PURSUIT_TYPE = declare("Pursuit Type", ComboBox.class);
    public static final AssetDescriptor<TextBox> AMOUNT_EXPECTED = declare("Amount Expected", TextBox.class);
    public static final AssetDescriptor<TextBox> AMOUNT_RECOVERED = declare("Amount Recovered", TextBox.class);
