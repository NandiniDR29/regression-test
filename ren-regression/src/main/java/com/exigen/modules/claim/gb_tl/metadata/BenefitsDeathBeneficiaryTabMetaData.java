...
public class BenefitsDeathBeneficiaryTabMetaData extends MetaData {
    public static final AssetDescriptor<Button> ADD_DEATH_BENEFICIARY_BUTTON = declare("Add Death Beneficiary", Button.class, Waiters.DEFAULT, false,
            By.id("policyDataGatherForm:addPrecClaimsBeneficiary"));
