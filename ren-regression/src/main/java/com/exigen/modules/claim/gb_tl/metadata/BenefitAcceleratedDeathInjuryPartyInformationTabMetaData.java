...
public class BenefitAcceleratedDeathInjuryPartyInformationTabMetaData extends MetaData {
    public static final AssetDescriptor<Link> ADD_NEW_BENEFIT_ACCELERATED_DEATH = declare("Add Benefit: Accelerated Death", Link.class, By.id("productConsolidatedViewForm:addDamageAcceleratedDeath"));
