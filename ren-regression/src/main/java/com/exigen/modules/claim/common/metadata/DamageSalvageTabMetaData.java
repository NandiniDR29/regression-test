...
public class DamageSalvageTabMetaData extends MetaData {
    ...
    public static final AssetDescriptor<TextBox> DATE_VEHICLE_DESIGNATED_SALVAGE = declare("Date Vehicle Designated Salvage", TextBox.class);
    public static final AssetDescriptor<TextBox> DATE_SALVAGE_SOLD = declare("Date Salvage Sold", TextBox.class);
    public static final AssetDescriptor<TextBox> SALVAGE_SALE_AMOUNT = declare("Salvage Sale Amount", TextBox.class);
    public static final AssetDescriptor<TextBox> SALVAGE_OBTAINED_FROM = declare("Salvage Obtained From", TextBox.class);
