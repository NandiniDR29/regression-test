...
public class BillingAccountTabMetaData extends MetaData {
    ...
    public static final AssetDescriptor<ComboBox> INVOICING_CALENDAR_VALUE = declare("Invoicing Calendar", ComboBox.class, By.id("purchaseForm:createLinkedNonPremiumBA_invoicingStrategy"));
    ...
    public static final class BillingAccountGeneralOptions extends MetaData {
        ...
        public static final AssetDescriptor<AssetList> ADD_INVOICING_CALENDAR = declare("Add Invoicing Calendar", AssetList.class, com.exigen.ren.main.modules.billing.account.metadata.BillingAccountTabMetaData.InvoicingCalendarTab.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
