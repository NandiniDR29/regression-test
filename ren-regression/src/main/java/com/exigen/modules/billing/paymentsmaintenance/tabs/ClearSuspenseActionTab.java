...
public class ClearSuspenseActionTab extends ActionTab {
    ...
    public Tab fillTab(TestData td) {
        ...
        String paymentAmounts = td.getValue(com.exigen.ren.main.modules.billing.paymentsmaintenance.tabs.ClearSuspenseActionTab.class.getSimpleName(), "Payment Amount");
