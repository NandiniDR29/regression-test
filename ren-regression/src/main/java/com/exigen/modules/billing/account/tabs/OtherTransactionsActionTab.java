...
public class OtherTransactionsActionTab extends ActionTab {
    ...
    public Tab submitTab() {
        com.exigen.ren.main.modules.billing.account.tabs.OtherTransactionsActionTab.tableAllocations.getRow(1).getCell(WRITE_OFF_ALL.getName()).controls.checkBoxes.getFirst().setValue(true);
        com.exigen.ren.main.modules.billing.account.tabs.OtherTransactionsActionTab.buttonOk.click();
        return this;
    }
