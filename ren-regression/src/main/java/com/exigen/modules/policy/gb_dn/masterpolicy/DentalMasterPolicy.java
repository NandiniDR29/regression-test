...
import com.exigen.modules.policy.gb_dn.masterpolicy.actions.DentalMasterPolicyDataGatherAction;
...
public class DentalMasterPolicy implements GroupBenefitsMasterPolicy {
    private TestData defaultTestData = TestDataProvider.getDefaultTestDataProvider().get("modules/policy/gb_dn/master");
    protected static final Logger LOGGER = LoggerFactory.getLogger(DentalMasterPolicy.class);
    ...
    @Override
    public DentalMasterPolicyDataGatherAction dataGather() {
        return AutomationContext.getAction(DentalMasterPolicyDataGatherAction.class);
    }
