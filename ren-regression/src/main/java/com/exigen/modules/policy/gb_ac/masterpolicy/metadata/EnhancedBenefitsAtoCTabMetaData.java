...
public class EnhancedBenefitsAtoCTabMetaData extends MetaData {
    ...
    public static final AssetDescriptor<AssetList> CATASTROPHIC_ACCIDENT_BENEFIT = declare("Catastrophic pName Benefit", AssetList.class, CatastrophicAccidentBenefitMetaData.class,
    ...
    public static final AssetDescriptor<AssetList> ACCIDENT_FOLLOW_UP_TREATMENT_BENEFIT = declare("pName Follow-up Treatment Benefit", AssetList.class, AccidentFollowUpTreatmentBenefitMetadata.class, By.xpath("//div[@id='policyDataGatherForm:componentView_RenACClassGroupEnhancedBenefitsAccidentFollowupBenefit']"));
    ...
    public static final class AccidentFollowUpTreatmentBenefitMetadata extends MetaData {
        ...
        public static final AssetDescriptor<TextBox> ACCIDENT_FOLLOW_UP_TREATMENT_BENEFIT_AMOUNT = declare("pName Follow-up Treatment Benefit Amount", TextBox.class);
