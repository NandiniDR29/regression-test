...
import com.exigen.modules.policy.gb_di_ltd.masterpolicy.metadata.PlanDefinitionTabMetaData;
import com.exigen.modules.policy.gb_di_ltd.masterpolicy.tabs.*;
...
public interface LongTermDisabilityMasterPolicyContext {
    ...
    default TestData getLTDMasterPolicyIssueData(String dataGather, String testDataKey) {
        return longTermDisabilityMasterPolicy.getDefaultTestData(dataGather,testDataKey)
                .adjust(longTermDisabilityMasterPolicy.getDefaultTestData(TestDataKey.PROPOSE, TestDataKey.DEFAULT_TEST_DATA_KEY))
            //    .adjust(longTermDisabilityMasterPolicy.getDefaultTestData(TestDataKey.ACCEPT_CONTRACT, TestDataKey.DEFAULT_TEST_DATA_KEY))
                .adjust(longTermDisabilityMasterPolicy.getDefaultTestData(dataGather, testDataKey));
    }
