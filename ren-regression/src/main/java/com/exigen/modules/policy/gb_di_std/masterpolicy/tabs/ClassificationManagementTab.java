...
package com.exigen.modules.policy.gb_di_std.masterpolicy.tabs;

import com.exigen.ipb.eisa.controls.composite.TableExtended;
import com.exigen.istf.data.TestData;
import com.exigen.istf.webdriver.controls.Named;
import com.exigen.istf.webdriver.controls.composite.assets.MultiAssetList;
import com.exigen.modules.policy.gb_di_std.masterpolicy.metadata.ClassificationManagementTabMetaData;
...
public class ClassificationManagementTab extends DefaultTab {
    ...
    public static void selectPlan(String planName) {
        tablePlansAndCoverages.getRow(TableConstants.PlansAndCoverages.COVERAGE_NAME.getName(), planName).getCell(TableConstants.PlansAndCoverages.COVERAGE_NAME.getName()).click();
    }
}
