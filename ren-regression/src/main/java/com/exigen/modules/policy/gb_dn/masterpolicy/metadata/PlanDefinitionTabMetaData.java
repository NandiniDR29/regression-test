...
public class PlanDefinitionTabMetaData extends MetaData {
    public static final AssetDescriptor<Link> COPY_PLAN=declare("Copy Plan",Link.class,By.id("policyDataGatherForm:copyPlanButton"));
    ...
    public static final AssetDescriptor<Button> COPY_PLAN_CONFIRMATION = declare("Copy Plan Confirmation", Button.class, By.id("j_id_1_24_5m_1_2_11:copyPlanOk"));
    public static final AssetDescriptor<Link> CHANGE=declare("Change", Link.class, By.id("policyDataGatherForm:dataGatherView_ListPreconfigGroupCoverageDefinition:1:dataGatherView_List_Change"));
