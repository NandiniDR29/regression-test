...
public class CaseProfileSummaryPage extends SummaryPage {
    ...
    public static  void selectAccidentCase() {
       CommonBaseTest.driver.findElement(By.xpath("//a[contains(text(),'AccCaseTest')]")).click();
   }
    public static  void selectStatCase() {
        CommonBaseTest.driver.findElement(By.xpath("//a[contains(text(),'CaseProfile_Stat')]")).click();
    }
    public static  void selectSTDCase() {
        CommonBaseTest.driver.findElement(By.xpath("//a[contains(text(),'STDCase')]")).click();
    }
    public static  void selectDentalCase() {
        CommonBaseTest.driver.findElement(By.xpath("//a[contains(text(),'DentalCase')]")).click();
    }
