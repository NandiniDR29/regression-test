...
public class ClassificationManagementTabMetaData extends MetaData {
    ...
    //static final TextBox Delay= new TextBox(By.id("policyDataGatherForm:sedit_GroupClassDefaultClassRatingInfoDecimalView_estimatedParticipantCount"));
    public static final AssetDescriptor<TextBox> NUMBER_OF_PARTICIPANTS = declare("Number of Participants", TextBox.class,By.id("policyDataGatherForm:sedit_GroupClassDefaultClassRatingInfoDecimalView_estimatedParticipantCount"));
