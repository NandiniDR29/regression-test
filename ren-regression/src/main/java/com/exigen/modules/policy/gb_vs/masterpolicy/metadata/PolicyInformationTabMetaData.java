...
public class PolicyInformationTabMetaData extends MetaData {
    ...
    public static final AssetDescriptor<ComboBox> PRIOR_CARRIER_NAME = declare("Prior Carrier Name", ComboBox.class, Waiters.DEFAULT,By.id("policyDataGatherForm:sedit_Policy_priorCarrierName"));
    ...
    public static final AssetDescriptor<TextBox> RATE_GUARANTEE_MONTHS = declare("Rate Guarantee (Months)", TextBox.class ,Waiters.DEFAULT,By.id("policyDataGatherForm:sedit_Policy_policyRateGuarantee"));
    ...
    public static final AssetDescriptor<ComboBox> AGENCY_PRODUCER_COMBO = declare("Agency / Producer", ComboBox.class,Waiters.DEFAULT,true);
    ...
    public static final class AddAgencyMetaData extends MetaData {
        public static final AssetDescriptor<ComboBox> CHANNEL = declare("Channel", ComboBox.class,Waiters.DEFAULT,true);
        public static final AssetDescriptor<TextBox> AGENCY_NAME = declare("Agency Name", TextBox.class,Waiters.DEFAULT,true);
        public static final AssetDescriptor<TextBox> AGENCY_CODE = declare("Agency Code", TextBox.class,Waiters.DEFAULT,true);
        public static final AssetDescriptor<TextBox> ZIP_CODE = declare("Zip Code", TextBox.class,Waiters.DEFAULT,true);
        public static final AssetDescriptor<TextBox> CITY = declare("City", TextBox.class);
        public static final AssetDescriptor<TextBox> STATE = declare("State", TextBox.class);
        public static final AssetDescriptor<Button> BUTTON_OPEN_POPUP = declare(AbstractDialog.getDefaultPopupOpenerName(), Button.class, Waiters.DEFAULT, false, By.xpath("//a[.='Change Agency']"));
    }

    public static final class InternalTeamMetaData extends MetaData {

        public static final AssetDescriptor<ComboBox> SALES_REPRESENTATIVE = declare("Sales Representative", ComboBox.class,Waiters.DEFAULT, true, By.id("policyDataGatherForm:sedit_InternalTeamComponent_salesRepUserIdStr"));
        public static final AssetDescriptor<ComboBox> SALES_SUPPORT_ASSOCIATE = declare("Sales Support Associate", ComboBox.class,Waiters.DEFAULT, true,By.id("policyDataGatherForm:sedit_InternalTeamComponent_salesSuppAssoUserIdStr"));
