...
public class PremiumSummaryTabMetaData extends MetaData {
    ...
    public static final AssetDescriptor<AssetList> RATE_SECTION = declare("Rate", AssetList.class, com.exigen.ren.main.modules.policy.gb_tl.masterpolicy.metadata.PremiumSummaryTabMetaData.RateMetaData.class);
