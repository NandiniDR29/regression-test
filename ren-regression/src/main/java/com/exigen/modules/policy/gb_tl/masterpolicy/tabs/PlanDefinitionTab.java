...
public class PlanDefinitionTab extends DefaultTab {
    ...
    public static StaticElement popup=new StaticElement(By.id("cancelConfirmDialog_dialogTitle"),Waiters.DEFAULT);
    public static Button buttonNo=new Button(By.id("cancelConfirmDialogDialog_form:buttonNo"),Waiters.DEFAULT);
        ...
        assetList = new MultiAssetList(By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER), metaDataClass) {
            ...
            public void fill(TestData td) {
                if (td.containsKey(name)) {
                    if(popup.getValue().equalsIgnoreCase("Please confirm")){
                        buttonNo.click();
                    }
                    fillSection(td);
                }
