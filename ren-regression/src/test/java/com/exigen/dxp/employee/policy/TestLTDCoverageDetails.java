...
public class TestLTDCoverageDetails extends DXPBaseTest {
    @Test(priority = 10)
    public void testLTDCoverageDetails() throws Exception {
        logger = extent.startTest("TestLTDCoverageDetails");
        prop.load(fileInput);
