...
public class TestVisionPlanBMNQuoteCreation extends CommonBaseTest implements GroupVisionMasterPolicyContext {
    @Test(priority = 4)
    public void testVisionPlanB() throws IOException {
        logger = extent.startTest(groupNo+" TestVisionPlanBQuoteCreationMN");
        prop.load(fileInput);
        pName ="Other";
