...
public class TestTermLifePlanG4QuoteCreation extends CommonBaseTest implements TermLifeInsuranceMasterPolicyContext {
    @Test(priority = 8)
    public void testTermLifeG4() throws IOException {
