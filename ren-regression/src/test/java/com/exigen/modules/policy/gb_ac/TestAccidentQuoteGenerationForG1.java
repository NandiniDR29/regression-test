...
public class TestAccidentQuoteGenerationForG1 extends CommonBaseTest implements AccidentMasterPolicyContext {
    @Test(priority = 5)
    public void PlanDFAC() throws IOException {
            ...
            groupACMasterPolicy.getDefaultWorkspace().fillFromTo(groupACMasterPolicy.getDefaultTestData("DataGather", testDatapoint), PolicyInformationTab.class, com.exigen.modules.policy.gb_ac.masterpolicy.tabs.ClassificationManagementTab.class);
            reportLog(" Enter Tiers Count", 1);
            groupACMasterPolicy.getDefaultWorkspace().fillFromTo(groupACMasterPolicy.getDefaultTestData("DataGather", testDatapoint), ClassificationManagementTab.class, com.exigen.modules.policy.gb_ac.masterpolicy.tabs.PremiumSummaryTab.class);
            reportLog("Generate Rate", 1);
            groupACMasterPolicy.getDefaultWorkspace().fillFromTo(groupACMasterPolicy.getDefaultTestData("DataGather", testDatapoint), com.exigen.modules.policy.gb_ac.masterpolicy.tabs.PremiumSummaryTab.class, com.exigen.modules.policy.gb_ac.masterpolicy.tabs.PremiumSummaryTab.class);
