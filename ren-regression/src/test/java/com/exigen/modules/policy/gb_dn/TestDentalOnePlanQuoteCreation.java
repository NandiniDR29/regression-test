...
public class TestDentalOnePlanQuoteCreation extends CommonBaseTest implements DentalMasterPolicyContext {
    @Test(priority = 3)
    ...
    public void testDentalQuoteCreation() throws IOException {
        ...
        SaveMPForEmployer(PolicySummaryPage.labelPolicyNumber.getValue());
        reportLog("==========================================", 1);
    }
