...
public class TestTermLifePlanG1QuoteCreation extends CommonBaseTest implements TermLifeInsuranceMasterPolicyContext {
    @Test(priority = 8)
    public void testTermLifePlan1() throws IOException {
