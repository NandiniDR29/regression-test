...
public class TestTermLifePlanG6QuoteCreation extends CommonBaseTest implements TermLifeInsuranceMasterPolicyContext {
    @Test(priority = 8)
    public void testTermLifeG6() throws IOException {
