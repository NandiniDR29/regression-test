...
import static com.exigen.modules.policy.gb_vs.masterpolicy.tabs.PremiumSummaryTab.RatingReportView.expandRatingDetails;
import static com.exigen.modules.policy.gb_vs.masterpolicy.tabs.PremiumSummaryTab.RatingReportView.openRedistributionCalculatorSection;
import static com.exigen.ren.common.pages.MainPage.QuickSearch.search;

public class TestVisionPlanBTXQuoteCreation extends CommonBaseTest implements GroupVisionMasterPolicyContext {
    @Test(priority = 4)
    public void testVisionPlanB() throws IOException {
        ...
        reportLog("Navigate to Quote creation tab", 1);
            ...
            if (groupNo.equalsIgnoreCase("Group2")||groupNo.equalsIgnoreCase("Group12")) {
                redistrubution();
