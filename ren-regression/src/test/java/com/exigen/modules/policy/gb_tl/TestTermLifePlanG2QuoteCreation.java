...
public class TestTermLifePlanG2QuoteCreation extends CommonBaseTest implements TermLifeInsuranceMasterPolicyContext {
    @Test(priority = 8)
    public void testTermLifePlanG2() throws IOException {
