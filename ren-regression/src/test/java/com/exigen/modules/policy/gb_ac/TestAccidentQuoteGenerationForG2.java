...
public class TestAccidentQuoteGenerationForG2 extends CommonBaseTest implements AccidentMasterPolicyContext {
    @Test(priority = 5)
    public void PlanDFAC_PlanA() throws IOException {
        ...
        groupACMasterPolicy.getDefaultWorkspace().fillFromTo(groupACMasterPolicy.getDefaultTestData("DataGather", testDatapoint), ClassificationManagementTab.class, PremiumSummaryTab.class,false);
