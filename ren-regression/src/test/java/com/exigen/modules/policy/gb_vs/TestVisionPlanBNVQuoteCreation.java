...
public class TestVisionPlanBNVQuoteCreation extends CommonBaseTest implements GroupVisionMasterPolicyContext {
    @Test(priority = 4)
    public void testVisionPlanBNV() throws IOException {
