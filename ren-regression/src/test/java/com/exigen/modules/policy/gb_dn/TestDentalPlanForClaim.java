...
public class TestDentalPlanForClaim extends CommonBaseTest implements DentalMasterPolicyContext {
    @Test(priority = 3)
    ...
    public void testDentalQuoteCreation() throws IOException {
        ...
        String dataGather = testYamlSelectionForClaimPlanConfiguration(groupNo);
        ...
        reportLog(" Update Classification Management Section ", 1);
