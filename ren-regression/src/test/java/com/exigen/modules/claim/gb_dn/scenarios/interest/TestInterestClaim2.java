...
public class TestInterestClaim2 extends ClaimGroupBenefitsDNBaseTest {
    @Test(priority = 134)
    public void test_Interest_Claim2() throws IOException {

        logger = extent.startTest(groupNo + " Interest Claim 2" + Util.CurentDateandTime());
        prop.load(fileInput);
        ...
        dentalClaim.create(dentalClaim.getDefaultTestData("Interest", "TestData_Claim2"));
