...
public class Test_Accumlator_Claim7 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 65)
    public void testAccumlator_Claim7() throws IOException {


        logger = extent.startTest(groupNo + " testAccumlator_Claim7");
        prop.load(fileInput);
        ...
        reportLog("Submitting the Claim having CDT Code as D2954 ...", 1);

        dentalClaim.create(dentalClaim.getDefaultTestData("Accumulators", "TestData_Claim7"));
