...
public class Test_Anesthesia_Claim4 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 81)
    public void testAnesthesiaClaim4() throws IOException {
        ...
        reportLog("Submitting the Claim having CDT Code as D6010 ...", 1);

        dentalClaim.create(dentalClaim.getDefaultTestData("Anesthesia", "TestData_Claim4"));
