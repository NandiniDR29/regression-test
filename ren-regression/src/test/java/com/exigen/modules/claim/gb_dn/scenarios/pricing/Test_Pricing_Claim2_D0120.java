...
public class Test_Pricing_Claim2_D0120 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 138)
    public void testPricing_Claim2() throws IOException {


        logger = extent.startTest(groupNo + " testPricing_Claim2_D0120");
        prop.load(fileInput);
        ...
        dentalClaim.create(dentalClaim.getDefaultTestData("Pricing", "TestData_PricingClaim2"));
