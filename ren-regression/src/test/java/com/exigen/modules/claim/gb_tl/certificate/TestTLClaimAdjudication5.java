...
public class TestTLClaimAdjudication5 extends ClaimGroupBenefitsTLBaseTest {
    @Test(priority = 28)
    public void testClaimAddBenefit1() throws IOException {
        ...
        termLifeClaim.create(termLifeClaim.getDefaultTestData("DataGatherCertificate_Adjudication5", TestDataKey.DEFAULT_TEST_DATA_KEY));
        reportLog("Open Claim", 1);
        claim.claimOpen().perform();
        String claimNumber = ClaimSummaryPage.getClaimNumber();
        reportLog("Adding Benefit", 1);
        claim.addBenefit().perform(tdClaim.getTestData("NewBenefitAdjudication5", "TestData_Death")
        ...
        claim.calculateSingleBenefitAmount().perform(tdClaim.getTestData("CalculateASingleBenefitAmountAdjudication5", "TestData"), 1);
