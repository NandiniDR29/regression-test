...
public class TestPriorToMPeffdateD1110_Testcases_13 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 55)
    public void testPriorToMPeffdateD1110() throws IOException {


        logger = extent.startTest(groupNo + " testPriorToMPeffdateD1110");
        prop.load(fileInput);
        ...
        dentalClaim.create(dentalClaim.getDefaultTestData("DataGatherCertificate", "TestData_13"));
