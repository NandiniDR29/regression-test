...
public class TestclaimwithD674013andD624014_Testcases_27 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 39)
    public void testclaimwithD674013andD624014() throws IOException {

        logger = extent.startTest(groupNo + " testclaimwithD674013andD624014");
        prop.load(fileInput);
        ...
        dentalClaim.create(dentalClaim.getDefaultTestData("DataGatherCertificate", "TestData_27"));
        ...
        try {
            ...
            reportLog("Claim Auto Adjudicated"+ ClaimSummaryPage.labelClaimStatus,1);
        }
        reportLog("============================================", 1);
