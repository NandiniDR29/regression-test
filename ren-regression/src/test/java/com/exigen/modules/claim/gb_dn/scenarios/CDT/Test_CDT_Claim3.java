...
public class Test_CDT_Claim3 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 85)
    public void testCDTClaim3() throws IOException {
        ...
        dentalClaim.create(dentalClaim.getDefaultTestData("CDT", "TestData_Claim3"));
