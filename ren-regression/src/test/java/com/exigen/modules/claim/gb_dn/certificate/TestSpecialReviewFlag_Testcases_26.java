...
public class TestSpecialReviewFlag_Testcases_26 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 61)
    public void testSpecialReviewFlag() throws IOException {


        logger = extent.startTest(groupNo + " testSpecialReviewFlag");
        prop.load(fileInput);
        ...
        dentalClaim.create(dentalClaim.getDefaultTestData("DataGatherCertificate", "TestData_SpecialReviewFlag"));
