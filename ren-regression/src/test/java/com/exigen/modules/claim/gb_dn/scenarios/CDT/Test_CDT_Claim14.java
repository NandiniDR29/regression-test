...
public class Test_CDT_Claim14 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 96)
    public void testCDTClaim14() throws IOException {
        ...
        reportLog("Submitting the Claim having CDT Code as D5820 ...", 1);

        dentalClaim.create(dentalClaim.getDefaultTestData("CDT", "TestData_Claim14"));
