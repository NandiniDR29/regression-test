...
public class TestwithremarksbutnoquadD4341_Testcases_12 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 62)
    public void testwithremarksbutnoquadD4341() throws IOException {

        logger = extent.startTest(groupNo + " testwithremarksbutnoquadD4341");
        prop.load(fileInput);
        ...
        dentalClaim.create(dentalClaim.getDefaultTestData("DataGatherCertificate", "TestData_12"));
        ...
        if (CoveredCDT.equals("D4341"))
        {
            reportLog("The first CDT Code is displayed as Expected --> D4341 ",1);
        }
        else
        {
            logger.log(LogStatus.INFO,"Actual CDT displayed is "+ CoveredCDT + "instead of D4341 ");
        }
        ...
        reportLog("The Benefit Amount for the cdt code[D4341] is "+ CoveredBenefitAmt, 1);
        ...
        {
            reportLog("The Decision for cdt code[D4341] is Disallowed with remark for missing quadrant ",1);
        }
        else
        {
            logger.log(LogStatus.INFO,"Actual Decision for the cdt code[D4341] is "+ DecisionShown);
        }
