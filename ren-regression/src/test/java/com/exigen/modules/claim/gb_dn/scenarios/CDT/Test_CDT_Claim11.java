...
public class Test_CDT_Claim11 extends ClaimGroupBenefitsDNBaseTest {
    ...
    public void testCDTClaim9() throws IOException {
        ...
        reportLog("Submitting the Claim having CDT Code as D9940 ...", 1);

        dentalClaim.create(dentalClaim.getDefaultTestData("CDT", "TestData_Claim11"));
