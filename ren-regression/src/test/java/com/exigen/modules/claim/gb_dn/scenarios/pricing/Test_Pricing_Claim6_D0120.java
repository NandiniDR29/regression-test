...
public class Test_Pricing_Claim6_D0120 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 142)
    public void testPricing_Claim6() throws IOException {


        logger = extent.startTest(groupNo + " testPricing_Claim6_D0120");
        prop.load(fileInput);
        ...
        dentalClaim.create(dentalClaim.getDefaultTestData("Pricing", "TestData_PricingClaim6"));
