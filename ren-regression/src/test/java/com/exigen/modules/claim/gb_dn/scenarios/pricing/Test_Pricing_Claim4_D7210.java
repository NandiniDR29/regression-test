...
public class Test_Pricing_Claim4_D7210 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 140)
    public void testPricing_Claim4() throws IOException {


        logger = extent.startTest(groupNo + " testPricing_Claim4_D7210");
        prop.load(fileInput);
        ...
        dentalClaim.create(dentalClaim.getDefaultTestData("Pricing", "TestData_PricingClaim4"));
