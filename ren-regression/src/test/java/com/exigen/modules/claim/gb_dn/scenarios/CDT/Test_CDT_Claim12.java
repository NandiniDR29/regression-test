...
public class Test_CDT_Claim12 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 94)
    public void testCDTClaim12() throws IOException {
        ...
        reportLog("Submitting the Claim having CDT Code as D6090 ...", 1);

        dentalClaim.create(dentalClaim.getDefaultTestData("CDT", "TestData_Claim12"));
