...
public class TestInterestClaim3 extends ClaimGroupBenefitsDNBaseTest {
    @Test(priority = 135)
    public void test_Interest_Claim3() throws IOException {

        logger = extent.startTest(groupNo + " Interest Claim 3" + Util.CurentDateandTime());
        prop.load(fileInput);
        ...
        reportLog("Submitting the Claim having CDT Code as D7140 ...", 1);

        dentalClaim.create(dentalClaim.getDefaultTestData("Interest", "TestData_Claim3"));
