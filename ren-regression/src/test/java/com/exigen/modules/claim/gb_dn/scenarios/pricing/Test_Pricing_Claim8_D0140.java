...
public class Test_Pricing_Claim8_D0140 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 144)
    public void testPricing_Claim8() throws IOException {

        logger = extent.startTest(groupNo + " testPricing_Claim8_D0140");
        prop.load(fileInput);
        ...
        dentalClaim.create(dentalClaim.getDefaultTestData("Pricing", "TestData_PricingClaim8"));
