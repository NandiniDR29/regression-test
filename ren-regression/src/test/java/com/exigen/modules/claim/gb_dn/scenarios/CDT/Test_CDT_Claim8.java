...
public class Test_CDT_Claim8 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 90)
    public void testCDTClaim8() throws IOException {
        ...
        reportLog("Submitting the Claim having CDT Code as D2955 and D3333 ...", 1);

        dentalClaim.create(dentalClaim.getDefaultTestData("CDT", "TestData_Claim8"));
