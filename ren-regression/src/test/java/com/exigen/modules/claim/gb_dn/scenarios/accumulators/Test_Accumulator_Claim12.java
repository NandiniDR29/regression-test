...
public class Test_Accumlator_Claim12 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 68)
    public void testAccumlator_Claim12() throws IOException {

        logger = extent.startTest(groupNo + " testAccumlator_Claim12");
        prop.load(fileInput);
        ...
        reportLog("Submitting the Claim having CDT Code as D8090 ...", 1);

        dentalClaim.create(dentalClaim.getDefaultTestData("Accumulators", "TestData_Claim12"));
