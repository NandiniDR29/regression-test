...
public class Test_CDT_Claim5 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 87)
    public void testCDTClaim5() throws IOException {
        ...
        reportLog("Submitting the Claim having CDT Code as D9110 ...", 1);

        dentalClaim.create(dentalClaim.getDefaultTestData("CDT", "TestData_Claim5"));
