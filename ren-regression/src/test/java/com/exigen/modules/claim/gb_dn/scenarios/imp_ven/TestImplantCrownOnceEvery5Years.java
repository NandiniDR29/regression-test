...
public class TestImplantCrownOnceEvery5Years extends ClaimGroupBenefitsDNBaseTest {
    @Test(priority = 113)
    public void testImplantCrownOnceEvery5Years() throws IOException {

        logger = extent.startTest(groupNo + " ImplantCrownOnceEvery5Years " + Util.CurentDateandTime());
        prop.load(fileInput);
        ...
        dentalClaim.create(dentalClaim.getDefaultTestData("ImpVen", "TestData_ImplantCrownOnceEvery5Years"));
        ...
        dentalClaim.create(dentalClaim.getDefaultTestData("ImpVen", "TestData_ImplantCrownOnceEvery5Years_Decline"));
        assertThat(ClaimSummaryPage.labelClaimStatus).hasValue(ClaimConstants.ClaimStatus.LOGGED_INTAKE);
        dentalClaim.claimSubmit().perform();
