...
public class Test_CDT_Claim13 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 95)
    public void testCDTClaim13() throws IOException {
        ...
        reportLog("Submitting the Claim having CDT Code as D6010 and D6011 ...", 1);

        dentalClaim.create(dentalClaim.getDefaultTestData("CDT", "TestData_Claim13"));
