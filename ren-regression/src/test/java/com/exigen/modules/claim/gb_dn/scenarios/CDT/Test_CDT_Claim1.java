...
public class Test_CDT_Claim1 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 83)
    public void testCDTClaim1() throws IOException {
        ...
        reportLog("Submitting the Claim having CDT Code as D7210 and D3332 ...", 1);

        dentalClaim.create(dentalClaim.getDefaultTestData("CDT", "TestData_Claim1"));
