...
public class TestClaimCreationACIntake1 extends ClaimGroupBenefitsACBaseTest {
    @Test(priority = 47)
    public void testClaimCreationAC_Intake1() throws IOException {
        ...
        accHealthClaim.create(accHealthClaim.getGbACTestData().getTestData("DataGatherCertificate_Intake1", TestDataKey.DEFAULT_TEST_DATA_KEY));
