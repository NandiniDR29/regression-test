...
public class Test_CDT_Claim15 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 97)
    public void testCDTClaim15() throws IOException {
        ...
        reportLog("Submitting the Claim having CDT Code as D4210 and D4261 ...", 1);

        dentalClaim.create(dentalClaim.getDefaultTestData("CDT", "TestData_Claim15"));
