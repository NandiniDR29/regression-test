...
public class TestSTClaimCreationG1 extends ClaimGroupBenefitsSTBaseTest implements DisabilityClaimSTContext {

    @Test(priority = 31)
    public void testClaimCreationForRegularDBLValidateWeeksPriorEarningsData() throws IOException {
        commonSteps("TestData_C2");
    }

    @Test(priority = 32)
    public void testClaimCreationBenefitGreaterThanPlanMaximum() throws IOException {
        commonSteps("TestData_C3");
    }

    @Test(priority = 33)
    public void testClaimCreationBondingTest() throws IOException {
        commonSteps("TestData_C1");
    }
    ...
    private void commonSteps(String dataPoint) throws IOException {
        ...
        if(dataPoint.equalsIgnoreCase("TestData_C1")){
