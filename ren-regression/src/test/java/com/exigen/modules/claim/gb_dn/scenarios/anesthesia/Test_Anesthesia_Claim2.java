...
public class Test_Anesthesia_Claim2 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 79)
    public void testAnesthesiaClaim2() throws IOException {
        ...
        reportLog("Submitting the Claim having CDT Code as D7220 ...", 1);

        dentalClaim.create(dentalClaim.getDefaultTestData("Anesthesia", "TestData_Claim2"));
