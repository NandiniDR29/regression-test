...
public class    Test_Anesthesia_Claim1 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 69)
    public void testAnesthesiaClaim1() throws IOException {
        ...
        reportLog("Submitting the Claim having CDT Code as D7210 ...", 1);

        dentalClaim.create(dentalClaim.getDefaultTestData("Anesthesia", "TestData_Claim1"));
