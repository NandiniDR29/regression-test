...
public class Testquad10withnoremarksD4341_Testcases_11 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 57)
    public void testquad10withnoremarksD4341() throws IOException {


        logger = extent.startTest(groupNo + " testquad10withnoremarksD4341");
        prop.load(fileInput);
        ...
        dentalClaim.create(dentalClaim.getDefaultTestData("DataGatherCertificate", "TestData_11"));
        ...
        {
            reportLog("The CDT Code is displayed as Expected --> D4341 ",1);
        }
        else
        {
        ...
        {
            reportLog("The Decision for cdt code[D4341] is Disallowed with missing remarks ",1);
        }
        else
        {
