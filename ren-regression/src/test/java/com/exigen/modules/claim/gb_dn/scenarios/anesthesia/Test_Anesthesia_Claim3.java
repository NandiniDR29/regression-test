package com.exigen.modules.claim.gb_dn.scenarios.anesthesia;
...
public class Test_Anesthesia_Claim3 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 80)
    public void testAnesthesiaClaim3() throws IOException {


        logger = extent.startTest(groupNo + " TestAnesthesiaClaim");
        prop.load(fileInput);
        ...
        reportLog("Submitting the Claim having CDT Code as D3330 ...", 1);
        dentalClaim.create(dentalClaim.getDefaultTestData("Anesthesia", "TestData_Claim3"));
