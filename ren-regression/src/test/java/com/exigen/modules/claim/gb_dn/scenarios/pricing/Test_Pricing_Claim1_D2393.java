...
public class Test_Pricing_Claim1_D2393 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 137)
    public void testPricing_Claim1() throws IOException {


        logger = extent.startTest(groupNo + " testPricing_ClaimD2393");
        prop.load(fileInput);
        ...
        dentalClaim.create(dentalClaim.getDefaultTestData("Pricing", "TestData_PricingClaim1"));
