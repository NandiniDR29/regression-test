...
public class Test_CDT_Claim7 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 89)
    public void testCDTClaim7() throws IOException {
        ...
        reportLog("Submitting the Claim having CDT Code as D2740 ...", 1);

        dentalClaim.create(dentalClaim.getDefaultTestData("CDT", "TestData_Claim7"));
