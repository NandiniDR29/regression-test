...
public class Test_Pricing_Claim3_D4910 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 139)
    public void testPricing_Claim3() throws IOException {


        logger = extent.startTest(groupNo + " testPricing_Claim3_D4910");
        prop.load(fileInput);
        ...
        dentalClaim.create(dentalClaim.getDefaultTestData("Pricing", "TestData_PricingClaim3"));
