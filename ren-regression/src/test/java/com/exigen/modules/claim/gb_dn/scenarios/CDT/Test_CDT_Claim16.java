...
public class Test_CDT_Claim16 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 98)
    public void testCDTClaim16() throws IOException {
        ...
        reportLog("Submitting the Claim having CDT Code as D4341 and D4342 ...", 1);

        dentalClaim.create(dentalClaim.getDefaultTestData("CDT", "TestData_Claim16"));
