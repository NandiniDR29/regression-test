...
public class Test_Anesthesia_Claim5 extends ClaimGroupBenefitsDNBaseTest {

    @Test(priority = 82)
    public void testAnesthesiaClaim5() throws IOException {
        ...
        dentalClaim.create(dentalClaim.getDefaultTestData("Anesthesia", "TestData_Claim5"));
