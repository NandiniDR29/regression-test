...
public class TestTLClaimCreationIntake1 extends ClaimGroupBenefitsTLBaseTest {
    @Test(priority = 28)
    public void testClaimCreationCertificate() throws IOException {
        ...
        termLifeClaim.create(termLifeClaim.getDefaultTestData("DataGatherCertificate_Intake1", "TestData"));
