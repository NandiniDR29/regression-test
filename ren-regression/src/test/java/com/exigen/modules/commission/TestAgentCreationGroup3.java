...
public class TestAgentCreationGroup3 extends CommissionStrategyBaseTest {
    @Test(priority = 0)
    public void testAgentCreationGroup3() throws IOException {
        ...
        String agencyName = agency.createAgency(TestDataProvider.getDefaultTestDataProvider().get("modules/platform/admin/agencyvendor/agency", "DataGatherGroup3").getTestData(TestDataKey.TEST_DATA_KEY1));
        ...
        String agencyName2 = agency.createAgency(TestDataProvider.getDefaultTestDataProvider().get("modules/platform/admin/agencyvendor/agency", "DataGatherGroup3").getTestData(TestDataKey.TEST_DATA_KEY2));
        reportLog("Created Agent Name "+ agencyName,1);
    ...
    public void commonSteps(String agencyName,String agencyCode, String groupName){
        try{
            ...
            TestData flatTestData = TestDataProvider.getDefaultTestDataProvider().get("/modules/commission/commissionstrategy", "CommissionStrategyGroup3").getTestData("Flat_CommissionRule")
            ...
            createCommissionStrategy(TestDataProvider.getDefaultTestDataProvider().get("/modules/commission/commissionstrategy", "CommissionStrategyGroup3").getTestData("TestDataAccident")
            ...
            createCommissionStrategy(TestDataProvider.getDefaultTestDataProvider().get("/modules/commission/commissionstrategy", "CommissionStrategyGroup3").getTestData("TestDataSTD")
                    .adjust(gbCommissionRuleTab.getMetaKey(), ImmutableList.of(flatTestData)), false);

            reportLog("Add Strategy for Long Term Disability",1);
            createCommissionStrategy(TestDataProvider.getDefaultTestDataProvider().get("/modules/commission/commissionstrategy", "CommissionStrategyGroup3").getTestData("TestDataLTD")
                    .adjust(gbCommissionRuleTab.getMetaKey(), ImmutableList.of(flatTestData)), false);

            reportLog("Add Strategy for Term Life",1);
            createCommissionStrategy(TestDataProvider.getDefaultTestDataProvider().get("/modules/commission/commissionstrategy", "CommissionStrategyGroup3").getTestData("TestDataLife")
                    .adjust(gbCommissionRuleTab.getMetaKey(), ImmutableList.of(flatTestData)), false);
        }
        catch (Exception e) {
