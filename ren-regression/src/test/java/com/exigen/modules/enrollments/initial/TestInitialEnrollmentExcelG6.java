...
public class TestInitialEnrollmentExcelG6 extends CommonBaseTest implements  CustomerContext, EfolderContext {
    private static final File FILE1 = new File(PropertyProvider.getProperty(TestProperties.UPLOAD_FILES_LOCATION), "Initial Enrollment file9_FL_Vision.xlsx");
    private static final File FILE2 = new File(PropertyProvider.getProperty(TestProperties.UPLOAD_FILES_LOCATION), "Initial Enrollment file9_FL_Life_STD.xlsx");

    @Test(priority = 11)
    public void testInitialEnrollmentExcel() throws IOException, InvalidFormatException {
        logger = extent.startTest(groupNo + " TestInitialEnrollmentExcelG6");
        prop.load(fileInput);
