...
public class TestInitialEnrollmentExcelG4 extends CommonBaseTest implements CustomerContext, EfolderContext {
    private static final File FILE1 = new File(PropertyProvider.getProperty(TestProperties.UPLOAD_FILES_LOCATION), "Initial_Enrollment_NV.xlsx");

    @Test(priority = 11)
    public void testInitialEnrollmentExcel() throws IOException, InvalidFormatException {
        logger = extent.startTest(groupNo + " TestInitialEnrollmentExcelG4");
        prop.load(fileInput);
