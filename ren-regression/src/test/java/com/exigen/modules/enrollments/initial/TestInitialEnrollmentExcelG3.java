...
import static com.exigen.helpers.initialenrollment.InitialEnrollmentHelper.*;
...
public class TestInitialEnrollmentExcelG3 extends CommonBaseTest implements CustomerContext, EfolderContext {
    private static final File FILE1 = new File(PropertyProvider.getProperty(TestProperties.UPLOAD_FILES_LOCATION), "Initial Enrollment file49_GA_Acc.xlsx");
    private static final File FILE2 = new File(PropertyProvider.getProperty(TestProperties.UPLOAD_FILES_LOCATION), "Initial Enrollment file49_GA_Life_STD_LTD.xlsx");

    @Test(priority = 11)
    public void testInitialEnrollmentExcel() throws IOException, InvalidFormatException {
        logger = extent.startTest(groupNo + " TestInitialEnrollmentExcelG3");
        prop.load(fileInput);
