...
public class TestInitialEnrollmentExcelG11 extends CommonBaseTest implements CustomerContext, EfolderContext {
    private static final File FILE = new File(PropertyProvider.getProperty(TestProperties.UPLOAD_FILES_LOCATION), "Initial_Enrollment_MN.xlsx");
    @Test(priority = 15)
    ...
    public void enrollment(String customerId, File inputFile, int i) throws IOException, InvalidFormatException {
        ...
        String filename = InitialEnrollmentHelper.prepareXLSXFileForLoc(inputFile, customerId, i);
