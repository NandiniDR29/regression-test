...
public class FileMetaDataIncorrectModel extends Model {
    ...
    public void setAttributeTest(String attributeTest) {
    ...
    public boolean equals(Object o) {
        ...
        FileMetaDataIncorrectModel that = (FileMetaDataIncorrectModel) o;
        return Objects.equals(masterPolicyNumber, that.masterPolicyNumber) &&
                Objects.equals(attributeTest, that.attributeTest) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), masterPolicyNumber, attributeTest, participantCount, timestamp, fileIdentifier, fileName, fileId, enrollmentTerm, enrollmentFileType, enrollmentSource, enrollmentDataType, fullyEnrolledInd);
    }
}
