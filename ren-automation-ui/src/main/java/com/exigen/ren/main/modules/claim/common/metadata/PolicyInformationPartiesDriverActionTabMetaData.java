...
public class PolicyInformationPartiesDriverActionTabMetaData extends MetaData {
    ...
    public static final AssetDescriptor<RadioGroup> DISABLED = declare("Disabled", RadioGroup.class);
