...
import com.exigen.ren.main.modules.claim.common.metadata.GenerateOnDemandDocumentActionTabMetaData;

public class GenerateOnDemandDocumentActionTab extends ActionTab {
    public GenerateOnDemandDocumentActionTab() {
        super(GenerateOnDemandDocumentActionTabMetaData.class);
    }
}
