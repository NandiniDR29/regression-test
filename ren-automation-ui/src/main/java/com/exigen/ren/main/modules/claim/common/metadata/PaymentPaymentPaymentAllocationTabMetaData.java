...
public class PaymentPaymentPaymentAllocationTabMetaData extends MetaData {
    ...
    public static final AssetDescriptor<TextBox> WIB_DURATION_USED = declare("WIB Duration used", TextBox.class);
    public static final AssetDescriptor<TextBox> WIB_DURATION_REMAINING = declare("WIB Duration remaining", TextBox.class);
}