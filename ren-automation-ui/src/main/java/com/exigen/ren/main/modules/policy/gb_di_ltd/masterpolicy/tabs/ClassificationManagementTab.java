...
public class ClassificationManagementTab extends DefaultTab {
    ...
    public static TableExtended<TableConstants.CoverageRelationships> tableCoverageRelationships = new TableExtended<>("Coverage Relationships",
            By.xpath("//div[@id='policyDataGatherForm:dataGatherView_ListGroupClassGroupCoverageRelationship']//table"));
    public static TableExtended<TableConstants.PlansAndCoverages> tablePlansAndCoverages = new TableExtended<>("Plans And Coverages",
            By.xpath("//*[@id='policyDataGatherForm:groupCoverageDefinitionList']/div[1]/table"));
    public static TableExtended<ClassificationSubGroupsAndRatingColumns> tableClassificationSubGroupsAndRatingInfo =
            new TableExtended<>("Classification Sub-Groups And Rating Info",
                    ...
                    By.xpath("//div[@id='policyDataGatherForm:dataGatherView_ListGroupClassGroupCoverRelationship_SubGroupsRating_paginator_bottom']"));
    ...
    public static void selectPlan(String planName) {
        tablePlansAndCoverages.getRow(TableConstants.PlansAndCoverages.PLAN.getName(), planName).getCell(TableConstants.PlansAndCoverages.PLAN.getName()).click();
    }
}