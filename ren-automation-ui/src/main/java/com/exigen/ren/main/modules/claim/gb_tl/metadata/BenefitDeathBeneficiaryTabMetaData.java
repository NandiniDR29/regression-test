...
public class BenefitDeathBeneficiaryTabMetaData extends MetaData {
    public static final AssetDescriptor<Button> ADD = declare("Add Beneficiary", Button.class, By.id("policyDataGatherForm:addAccidentalDeathBeneficiary"));
    public static final AssetDescriptor<Button> REMOVE = declare("Remove Beneficiary", Button.class, By.id("policyDataGatherForm:eliminateAccidentalDeathBeneficiary"));
    public static final AssetDescriptor<ComboBox> PARTY_NAME = declare("Party Name", ComboBox.class);
    public static final AssetDescriptor<ComboBox> RELATIONSHIP_TO_DECEDENT = declare("Relationship To Decedent", ComboBox.class, Waiters.AJAX.then(Waiters.SLEEP(2000)));
    ...
    public static final AssetDescriptor<ComboBox> CONTACT_PREFERENCE = declare("Contact Preference", ComboBox.class, Waiters.AJAX.then(Waiters.SLEEP(2000)));
    public static final AssetDescriptor<ComboBox> PREFERRED_PAYMENT_METHOD = declare("Preferred Payment method", ComboBox.class, Waiters.AJAX.then(Waiters.SLEEP(2000)));
    ...
    public static final AssetDescriptor<ComboBox> QUALIFIED_TO_RECEIVE_BENEFIT = declare("Qualified to Receive Benefit", ComboBox.class);
    public static final AssetDescriptor<ComboBox> WILL_RECEIVE_BENEFIT = declare("Will Receive Benefit", ComboBox.class);
}
