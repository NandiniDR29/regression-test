...
public interface IClaim extends EntityService {
    Logger LOGGER = LoggerFactory.getLogger(IClaim.class);
    ...
    default void initiateCreation() {
       // CommonBaseTest.reportLog("Navigate to Claim Tab",1);
        navigateToClaim();
       // CommonBaseTest.reportLog("Initiate Claim Creation",1);
        ClaimSummaryPage.buttonCreateNewClaim.click();
    }

    default void initiate(TestData td) {
        initiateCreation();
      //  CommonBaseTest.reportLog("Fill required Information",1);
    ...
    default void create(TestData td) {
     ...
     //   CommonBaseTest.reportLog("Created Claim " + EntityLogger.getEntityHeader(EntityLogger.EntityType.CLAIM),1);
        LOGGER.info("Created Claim " + EntityLogger.getEntityHeader(EntityLogger.EntityType.CLAIM));
    }
    ...
    default Action claimOpen() {
       // CommonBaseTest.reportLog("OpenClaim",1);
    ...
    default Action claimSubmit() {
     //   CommonBaseTest.reportLog("Submit Claim",1);
        return AutomationContext.getAction(ClaimSubmitAction.class);
    }

    default Action claimReadjudicate() {
        return AutomationContext.getAction(ClaimReadjudicateAction.class);
    }
