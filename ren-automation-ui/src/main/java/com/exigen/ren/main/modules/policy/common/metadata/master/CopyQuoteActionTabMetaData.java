...
public class CopyQuoteActionTabMetaData extends MetaData {
    ...
    public static final AssetDescriptor<RadioGroup> COPY_UNDERWRITTEN_RATES = declare("Copy Underwritten Rates?", RadioGroup.class);
}
