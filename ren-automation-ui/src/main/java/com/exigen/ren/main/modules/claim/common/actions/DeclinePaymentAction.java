...
import com.exigen.ren.main.modules.claim.common.tabs.DeclinePaymentActionTab;
...
public class DeclinePaymentAction implements Action {
    ...
    public Action submit() {
        new Button(By.id("policyDataGatherForm:ok_ClaimsDeclinePaymentAction_footer")).click();
        return this;
    }
}
