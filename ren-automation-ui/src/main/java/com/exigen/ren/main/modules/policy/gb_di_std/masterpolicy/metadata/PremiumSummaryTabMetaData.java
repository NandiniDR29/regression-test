...
public class PremiumSummaryTabMetaData extends MetaData {
    ...
    public static final class ExperienceRatingMetaData extends MetaData {
        ...
        public static final AssetDescriptor<TextBox> CREDIBILITY_FACTOR = declare("Credibility Factor", TextBox.class, By.id("policyDataGatherForm:sedit_ExperienceRatingViewOnlyComponent_credibilityFactor"));
    }
