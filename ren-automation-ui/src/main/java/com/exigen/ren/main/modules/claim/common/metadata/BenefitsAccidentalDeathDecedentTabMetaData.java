...
public class BenefitsAccidentalDeathDecedentTabMetaData extends MetaData {
    //group benefits
    public static final AssetDescriptor<Link> ADD_BENEFIT_ACCIDENTAL_DEATH = declare("Add Benefit: Accidental Death", Link.class, By.id("productConsolidatedViewForm:addDamageAccidentalDeath"));
