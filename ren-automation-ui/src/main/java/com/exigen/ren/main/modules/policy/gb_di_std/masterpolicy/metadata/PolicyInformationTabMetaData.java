...
package com.exigen.ren.main.modules.policy.gb_di_std.masterpolicy.metadata;
...
public class PolicyInformationTabMetaData extends MetaData {
    ...
    public static final AssetDescriptor<CheckBox> WORKERS_COMPENSATION = declare("Workers Compensation", CheckBox.class);
    public static final AssetDescriptor<CheckBox> IN_COURSE_OF_EMPLOYMENT = declare("In Course of Employment", CheckBox.class);
    ...
    public static final AssetDescriptor<CheckBox> RIOT = declare("Riot", CheckBox.class);
    public static final AssetDescriptor<CheckBox> FELONY = declare("Felony", CheckBox.class);
