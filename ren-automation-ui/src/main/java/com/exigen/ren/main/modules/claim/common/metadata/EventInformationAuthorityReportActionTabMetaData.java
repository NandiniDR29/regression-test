...
public class EventInformationAuthorityReportActionTabMetaData extends MetaData {
    public static final AssetDescriptor<TextBox> DATE_REPORTED_TO_AUTHORITIES = declare("Date Reported to Authorities", TextBox.class);
    public static final AssetDescriptor<TextBox> TIME_REPORTED_TO_AUTHORITIES = declare("Time Reported to Authorities", TextBox.class);
    public static final AssetDescriptor<ComboBox> TYPE_OF_AUTHORITY = declare("Type of Authority", ComboBox.class);
    public static final AssetDescriptor<TextBox> DESCRIPTION_OF_OTHER = declare("Description of Other", TextBox.class);
    public static final AssetDescriptor<TextBox> REPORT_REFERENCE = declare("Report Reference #", TextBox.class);
