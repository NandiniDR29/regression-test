...
package com.exigen.ren.main.modules.policy.gb_di_std.certificate.metadata;
...
public class CoveragesTabMetaData extends MetaData {
    ...
    public static final AssetDescriptor<TextBox> WEEKLY_BENEFIT_MOUNT = declare("Weekly Benefit Amount", TextBox.class);
    ...
    public static final AssetDescriptor<TextBox> CURRENT_EFFECTIVE_AMOUNT = declare("Current Effective Amount", TextBox.class);
    public static final AssetDescriptor<TextBox> REQUESTED_PERCENT = declare("Requested %", TextBox.class);
    public static final AssetDescriptor<TextBox> PENDING_PERCENT = declare("Pending %", TextBox.class);
