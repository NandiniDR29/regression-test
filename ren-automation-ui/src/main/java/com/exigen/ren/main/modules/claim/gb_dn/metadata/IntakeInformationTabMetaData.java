...
public class IntakeInformationTabMetaData extends MetaData {
    ...
    public static final class SearchProviderMetaData extends MetaData {
        ...
        public static final AssetDescriptor<TextBox> CITY = declare("City", TextBox.class);
        public static final AssetDescriptor<ComboBox> STATE_PROVINCE = declare("State/Province", ComboBox.class);
        public static final AssetDescriptor<Button> SEARCH_VENDOR = declare("Search Vendor", Button.class, doubleWaiter.then(Waiters.SLEEP(1000)), false, By.id("policyDataGatherForm:searchBtn_ClaimsDentalVendorSearch"));
        public static final AssetDescriptor<Link> ADD_VENDOR = declare("Add Vendor", Link.class, Waiters.AJAX,
