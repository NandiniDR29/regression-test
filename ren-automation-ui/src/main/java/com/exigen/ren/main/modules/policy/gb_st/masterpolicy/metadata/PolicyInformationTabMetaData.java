...
public class PolicyInformationTabMetaData extends MetaData {
    ...
    public static final AssetDescriptor<TextBox> POLICY_EFFECTIVE_DATE = declare("Policy Effective Date", TextBox.class, Waiters.DEFAULT);
    public static final AssetDescriptor<TextBox> CURRENT_POLICY_YEAR_START_DATE = declare("Current Policy Year Start Date", TextBox.class, Waiters.DEFAULT);
    ...
    public static final AssetDescriptor<RadioGroup> SMALL_GROUP = declare("Small Group?", RadioGroup.class, Waiters.DEFAULT);
    ...
    public static final AssetDescriptor<RadioGroup> UNDER_FIFTY_LIVES_WORKFLOW = declare("Under 50 Lives Workflow?", RadioGroup.class, Waiters.AJAX.then(Waiters.SLEEP(5000)));
