...
import com.exigen.ren.main.modules.claim.common.tabs.VoidPaymentActionTab;
import com.exigen.ren.main.pages.summary.claim.ClaimSummaryPage;
import org.openqa.selenium.By;

public class VoidPaymentAction implements Action {

    private Workspace workspace = new Workspace.Builder()
            .registerTab(VoidPaymentActionTab.class)
            .build();
    ...
    public Action start(int rowNumber) {
        ...
        ClaimSummaryPage.tableSummaryOfClaimPaymentsAndRecoveries.getRow(rowNumber).getCell(ClaimConstants.ClaimSummaryOfPaymentsAndRecoveriesTable.PAYMENT_NUMBER).controls.links.getFirst()
                .click();
        new Button(By.id("policyDataGatherForm:paymentActionLink_voidPayment")).click();
        return this;
    }
    ...
    public Action submit() {
        new Button(By.id("policyDataGatherForm:ok_ClaimsVoidPaymentAction_footer")).click();
        return this;
    }
}
