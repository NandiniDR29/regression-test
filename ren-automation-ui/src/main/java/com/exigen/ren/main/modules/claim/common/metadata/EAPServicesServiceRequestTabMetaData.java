...
public class EAPServicesServiceRequestTabMetaData extends MetaData {
    ...
    public static final AssetDescriptor<RadioGroup> CREATE_NEW_VENDOR = declare("Create New Vendor?", RadioGroup.class);
    ...
    public static final AssetDescriptor<Button> ADD = declare("Add", Button.class, By.id("policyDataGatherForm:addClaimsServiceRequest"));
}
