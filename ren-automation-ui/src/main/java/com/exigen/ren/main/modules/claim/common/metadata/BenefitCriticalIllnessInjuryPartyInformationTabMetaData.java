...
public class BenefitCriticalIllnessInjuryPartyInformationTabMetaData extends MetaData {
    public static final AssetDescriptor<Link> ADD_BENEFIT_CRITICAL_ILLESS = declare("Add Benefit: Critical Illness", Link.class, By.id("productConsolidatedViewForm:addDamageCriticalIllness"));
