...
public class InsuredTabMetaData extends MetaData {
    ...
    public static final class RelationshipInformationMetaData extends MetaData {
        ...
        public static final AssetDescriptor<RadioGroup> EXPATRIATE = declare("Expatriate", RadioGroup.class, By.id("policyDataGatherForm:sedit_GroupCertificatePolicyRelationshipEmpInfo_expatriate"));
        public static final AssetDescriptor<ComboBox> PAY_TYPE = declare("Pay Type", ComboBox.class);
        public static final AssetDescriptor<RadioGroup> UNION_MEMBER = declare("Union Member", RadioGroup.class, By.id("policyDataGatherForm:sedit_GroupCertificatePolicyRelationshipEmpInfo_unionMember"));
        ...
        public static final AssetDescriptor<TextBox> CLASSIFICATION_SUBGROUP = declare("Classification Sub-group", TextBox.class);
    }
