...
public class ReportingPartyAndClaimContactActionTabMetaData extends MetaData {
    ...
    public static final AssetDescriptor<TextBox> PARTY_NAME = declare("Party Name", TextBox.class);
