...
package com.exigen.ren.admin.modules.cms.printmonitor.printrequest.metadata;
...
public class PrintRequestMetaData extends MetaData {
    ...
    public static final AssetDescriptor<TextBox> ENTITY_NUMBER = declare("Entity Number", TextBox.class, By.id("criteriaForm:entityRefNo"));
