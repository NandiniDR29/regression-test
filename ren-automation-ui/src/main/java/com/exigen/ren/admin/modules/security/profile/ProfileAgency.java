...
public class ProfileAgency extends Profile {
    private static final ProfileType PROFILE_TYPE = ProfileType.AGENCY;

    @Override
    public TestData defaultTestData() {
        return TestDataProvider.getDefaultTestDataProvider().get("modules/platform/admin/security/profile/agency");
    }
    ...
    public void create(TestData td) {
        ...
        LOGGER.info("Created Profile " + td);
    }
}
