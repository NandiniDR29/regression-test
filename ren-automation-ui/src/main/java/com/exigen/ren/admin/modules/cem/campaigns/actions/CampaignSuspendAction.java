...
import com.exigen.ren.admin.modules.cem.campaigns.tabs.SuspendCampaignTab;
import com.exigen.ren.common.Action;
import com.exigen.ren.common.Workspace;
import com.exigen.ren.common.pages.Page;

public class CampaignSuspendAction implements Action {
    private Workspace workspace = new Workspace.Builder()
            .registerTab(SuspendCampaignTab.class)
            .build();
