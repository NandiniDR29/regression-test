...
public class ContactInfoMetaData extends MetaData {
    ...
    public static final AssetDescriptor<RadioGroup> IS_MAILING_ADDRESS_THE_SAME_AS_PHYSICAL_ADDRESS = declare(
            "Is Mailing Address the same as Physical Address?", RadioGroup.class);
}
